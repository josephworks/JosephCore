...
package net.josephworks.josephcore.world.dimension;
...
import net.josephworks.josephcore.item.JosephLandItem;
...
public class JosephLandDimension extends JosephCoreElements.ModElement {
	@ObjectHolder("josephcore:josephland")
	public static final ModDimension dimension = null;
	@ObjectHolder("josephcore:josephland_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public JosephLandDimension(JosephCoreElements instance) {
		super(instance, 27);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("josephland"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("josephcore:josephland")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("josephcore:josephland"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("josephcore:josephland"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("ocean")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("taiga")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("swamp")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("river")), ForgeRegistries.BIOMES.getValue(new ResourceLocation("nether")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_end")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("frozen_ocean")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("frozen_river")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("mushroom_field_shore")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("taiga_hills")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("snowy_beach")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("birch_forest")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("birch_forest_hills")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("giant_tree_taiga")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("giant_tree_taiga_hills")),
				...
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("sunflower_plains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("desert_lakes")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("gravelly_mountains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("flower_forest")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("taiga_mountains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("swamp_hills")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("ice_spikes")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("modified_jungle")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("modified_jungle_edge")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("tall_birch_forest")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("tall_birch_hills")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("dark_forest_hills")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("snowy_taiga_mountains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("giant_spruce_taiga")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("giant_spruce_taiga_hills")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("modified_gravelly_mountains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("shattered_savanna")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("shattered_savanna_plateau")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("eroded_badlands")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("modified_wooded_badlands_plateau")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("modified_badlands_plateau")),
	...
	public void initElements() {
		...
		elements.items.add(() -> new JosephLandItem().setRegistryName("josephland"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("josephland_portal");
		}
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, Direction p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.func_196900_a(this.world.getBlockState(blockpos))
							|| !(this.world.getBlockState(blockpos.down()).getBlock() == ForgestoneBlock.block.getDefaultState().getBlock())) {
						break;
					}
				}
				BlockPos framePos = p_180120_1_.offset(p_180120_2_, i);
				return (this.world.getBlockState(framePos).getBlock() == ForgestoneBlock.block.getDefaultState().getBlock()) ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (!(this.world.getBlockState(framePos).getBlock() == ForgestoneBlock.block.getDefaultState().getBlock())) {
								break label56;
							}
					...
					for (int i8 = 1; i8 < 3; ++i8) {
						for (int i9 = -1; i9 < 3; ++i9) {
							...
							this.world.setBlockState(blockpos$mutableblockpos,
									flag ? ForgestoneBlock.block.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutableblockpos, ForgestoneBlock.block.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				...
				public BlockState getDefaultFluid() {
					return Blocks.BUBBLE_COLUMN.getDefaultState();
				}
			});
