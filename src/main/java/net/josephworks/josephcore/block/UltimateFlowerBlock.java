...
public class UltimateFlowerBlock extends JosephCoreElements.ModElement {
	@ObjectHolder("josephcore:ultimateflower")
	public static final Block block = null;
	public UltimateFlowerBlock(JosephCoreElements instance) {
		super(instance, 26);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS, MaterialColor.EMERALD).tickRandomly().doesNotBlockMovement().sound(SoundType.GROUND)
					.hardnessAndResistance(0f, 0f).lightValue(15));
			setRegistryName("ultimateflower");
		}
